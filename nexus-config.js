...
(() => {
  const loadHomeDashboard = () => {
    ...
    script.src = 'home-dashboard-v227.js?v=2.31';
    script.dataset.nexusHomeDashboard = 'v2.31';
    script.async = false;
  ...
  const loadPolarIntelligence = () => {
    ...
    const script = document.createElement('script');
    script.src = 'polar-intelligence-v222.js?v=2.31';
    script.dataset.nexusPolarIntelligence = 'v2.31';
    script.async = false;
